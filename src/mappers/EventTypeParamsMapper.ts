 ...
 * @returns T
 */
export function EventTypeParamsMapper<T extends IEventParams>(
  eventType: EventType,
  args: any[]
): T {
  let params = {
  ...
  switch (eventType) {
    ...
    case EventType.RESUB:
      params = Object.assign(params, {
        Username: args[1],
        Message: args[3],
        CumulativeMonths: args[4]["msg-param-cumulative-months"],
      }) as ResubEventParams;
      break;
    ...
    case EventType.SUBMYSTERYGIFT:
      params = Object.assign(params, {
        Username: args[1],
        OfferedSubs: args[2],
        GiftCount: args[4]["msg-param-sender-count"],
